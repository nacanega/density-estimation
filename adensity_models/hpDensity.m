...
dadM = [(vx*(((Ubconst)/(2*r) + sym(1/2))^(n/2) - 1)), -(vx*((Ubconst)/(2*r) + sym(1/2))^(n/2));
        (vy*(((Ubconst)/(2*r) + sym(1/2))^(n/2) - 1)), -(vy*((Ubconst)/(2*r) + sym(1/2))^(n/2));
        (vz*(((Ubconst)/(2*r) + sym(1/2))^(n/2) - 1)), -(vz*((Ubconst)/(2*r) + sym(1/2))^(n/2))];
